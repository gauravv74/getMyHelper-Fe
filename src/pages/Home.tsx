    ...
    <>
      <div className="jumbotron jumbotron-fluid text-center bg-light">
        <div className="container">
          <h1 className="display-4">Welcome to Get My Helper</h1>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p>Our seamless booking process allows you to quickly and easily schedule a service
                ...
                choose a date and time, and sit back and relax while Get  My Helper takes care of the
            ...
            <div className="col-md-6">
              ...
              <p>Get  My Helper offers competitive pricing, with transparent and upfront quotes for all
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 order-md-2">
              ...
              <p>With Get  My Helper, you can rest assured that your home renovation project is in good
            ...
            <div className="col-md-6 order-md-1">
              ...
              <p>Our top priority is customer satisfaction. We work closely with you to understand your
                ...
                expectations. Try Get  My Helper today and see the difference for yourself.</p>
            </div>
          </div>
        </div>
      </div>
      <div className="container-fluid text-center py-5">
        ...
        <p className="lead">Book a service appointment with Get  My Helper and let our experts take care of your
