...
const Services = () => {
  ...
  const handleSeeProviders =(service: Service) => {
    navigate('/customer/providers', {state: {service: service}});
  }
          ...
          <div key={service.service._id} className="card mb-4">
            ...
            <div className="card-body">
              ...
              {localStorage.getItem("user_type") === CustomerString && (
               <div> <span className="btn btn-primary btn-service-master-bg text-dark"
                      onClick={() => handleBook(service)}>Book</span>
                       <span className="btn btn-primary btn-service-master-bg text-dark"
                      onClick={() => handleSeeProviders(service)}>See Providers</span>
                      </div>
