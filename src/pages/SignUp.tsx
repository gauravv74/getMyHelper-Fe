...
const SignUp = () => {
  ...
  return (
   ...
   {  inputs.type == ProviderString ?
    <>
                  
                 
                  <div className={`form-group mb-4`}>
                    <label htmlFor="password-field" className="mb-3 input-label">Experience</label>
                    <input
                      name="experience"
                      type="number"
                      className={`form-control input-field`}
...
// echo "# getMyHelper-Fe" >> README.md
// git init
// git add README.md
// git commit -m "first commit"
// git branch -M main
// git remote add origin https://github.com/gauravv74/getMyHelper-Fe.git
